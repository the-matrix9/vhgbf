...
from UTTAM import CMD_HELP, StartTime, app
from UTTAM.helper.data import Data
from UTTAM.helper.inline import inline_wrapper, paginate_help
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("──「 ʙᴏᴛᴍɪɴᴇ-ᴛᴇᴄʜ 」──", callback_data="helper")]]
            ),
        )
    )
    return answers
