...
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(
        message,
" ᴀʙᴇ ɢᴀɴᴅᴜ😂😂...ʙᴀᴀᴘ sᴇ ʙᴀᴋᴄʜᴏᴅɪ ᴍᴀᴛ ᴋᴀʀ ɴᴀɪ ᴛᴏ ᴀssᴀ ᴘᴇʟᴜɢᴀ ᴊᴀʜᴀ sᴇ ᴀʏʏᴀ ᴛʜᴀ ᴏʙʜɪ ᴄʜᴀʟᴀ ᴊᴀʏᴇɢᴀ👻 ",
    )


@Client.on_message(
    filters.me & (filters.command(["radhe"], ".") | filters.regex("^nexio"))
)
async def hello_world(client: Client, message: Message):
    mg = await edit_or_reply(message, "ʀᴀᴅʜᴇ")
    ...
    await mg.edit("ᴛᴏᴘɪ")
    await asyncio.sleep(0.3)
    await mg.edit(" ʜᴜᴍ ʙᴀᴘ ʜᴀɪ ᴛᴜᴍʜᴀʀᴇ ᴛᴜᴍ ʟᴏᴅᴇ ʜᴏ ʜᴜᴍᴀʀᴇ💘")
...
async def gkahgagw(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
        "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
        "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [ʙᴏᴛᴍɪɴᴇ ᴛᴇᴄʜ](https://t.me/BOTMINE_TECH) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜",
    ]
    if message.forward_from:
        return
...
async def gajjajay(client: Client, message: Message):
    ...
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("EVERyBOdy iZ GangSTur UNtIL #patel ArRivE 🔥🔥🔥")
...
async def awikwok(client: Client, message: Message):
    await edit_or_reply(
        ...
        "▄▀──█▄▄──────█─█▄▄\n"
        "─▄▄▄▀──▀▄───▄▄▄▀──▀▄\n"
        "─▀───────▀▀─▀───────▀▀\n`ɴɪᴋᴀʟ ᴍᴄ😥😥.. ɢᴀᴀʟɪ ɴᴀ ᴅᴇ ᴠᴀʀɴᴀ ᴍᴀɪ ᴛᴇʀɪ ɢ**ᴅ ᴍᴀᴀʀ ʟᴜɢᴀ.👻`",
    )
